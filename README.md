...
南+ 是一个非官方的论坛客户端，重点解决手机访问论坛时常见的不方便：页面拥挤、切换慢、回复麻烦、收藏和付费帖操作割裂。
...
<table>
  ...
  <tr>
    <td width="50%">
      <h3>自动签到与任务领取</h3>
      <p>首页提供任务入口，支持快速领取奖励；签到类任务会自动申请再领取，减少重复点页面的麻烦。</p>
    </td>
    <td width="50%">
      <h3>图片预览更顺手</h3>
      <p>主题列表和帖子详情会优化图片预览，大图加载更稳，小图、表情和配图也能保持正常显示。</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>暗黑模式</h3>
      <p>登录、首页、帖子、搜索、收藏、历史、回复和账号页都适配深色界面，夜间浏览更舒服。</p>
    </td>
    <td width="50%">
      <h3>版本更新更清楚</h3>
      <p>应用内可检查新版本，发布页提供分架构 Android 包、iOS sideload IPA、Windows 包和校验文件，下载更放心。</p>
    </td>
  </tr>
</table>
...
南+ 是第三方客户端，不是论坛官方应用。项目只提供更适合移动端的访问体验，不提供、存储或分发论坛内容。请遵守所在地法律法规和论坛规则，使用自己的账号，并自行判断内容访问风险。
